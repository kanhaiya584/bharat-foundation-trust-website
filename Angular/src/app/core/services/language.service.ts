...
export class LanguageService {
  ...
  private readonly dictionary: Record<string, string> = {
    'Home': 'होम', 'About Us': 'बारे में', 'Our Work': 'हमारा कार्य', 'Donate': 'दान', 'Donate Now': 'अभी दान करें', 'Contact': 'संपर्क', 'Login': 'लॉगिन', 'Health': 'स्वास्थ्य', 'Bharat Foundation Trust': 'भरत फाउंडेशन ट्रस्ट',
  ...
  private readonly workDictionary: Record<string, string> = {
    ...
    "Bharat Foundation Trust's purpose is to bring support and opportunities to those in society who need it most.": 'भरत फाउंडेशन ट्रस्ट का उद्देश्य समाज के उन लोगों तक सहायता और अवसर पहुँचाना है जिन्हें इसकी सबसे अधिक आवश्यकता है।',
    'The trust works through': 'ट्रस्ट',
    'education, healthcare, skill development and social support': 'शिक्षा, स्वास्थ्य, कौशल विकास और सामाजिक सहायता',
    'to bring about positive change.': 'के माध्यम से सकारात्मक बदलाव लाने का प्रयास करता है।',
    'Our approach keeps donations transparent, programs focused and beneficiaries at the center of every decision.': 'हमारी कार्यप्रणाली में दान पारदर्शी, कार्यक्रम केंद्रित और हर निर्णय में लाभार्थी सबसे महत्वपूर्ण होते हैं।',
    'We work with': 'हम',
    'volunteers, local partners': 'स्वयंसेवकों, स्थानीय भागीदारों',
    'and donors who want to see transparent outcomes.': 'और पारदर्शी परिणाम चाहने वाले दाताओं के साथ काम करते हैं।',
